...
export default function Login() {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50 animate-in fade-in">
        ...
        <CardContent className="pt-6">
          ...
          <div className="mt-6 text-center">
            ...
            <ul className="text-left space-y-2 text-sm">
              ...
              <li className="flex items-center">
                <Shuffle className="h-5 w-5 text-blue-500 mr-2" />
                10 random numbers will appear one by one
              </li>
              <li className="flex items-center">
                <Hand className="h-5 w-5 text-[hsl(var(--secondary))] mr-2" />
